...
"A local black market merchant has taken his business to just outside your tavern, he now sells things to people coming in and out",
"A local government official entered your tavern and inspected it for cleanliness",
"A traveller came into your tavern bleeding and pleaded for aid",
...
export const staffNeutralEvents = [
...
export const staffNegativeEvents = [
"During an argument turned violent between two locals in your tavern, one of your guards moves to de-escalate the situation.  One of the locals pulls a knife.  During your guard's attempt to disarm the local, the blade catches his throat and he bleeds out minutes later.  You have lost a guard, and your tavern empties for the day following this event. You lose some income today.",
...
export const staffPositiveEvents = [
